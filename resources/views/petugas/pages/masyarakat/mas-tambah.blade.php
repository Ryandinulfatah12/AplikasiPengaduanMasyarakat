  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="form-header blue accent-1">
        <h3><i class="fas fa-envelope"></i> Tambah Data Masyarakat</h3>
      </div>
      <!--Body -->
      <form action="{{route('save.mas')}}" method="POST">
        @csrf
        <div class="modal-body mb-0">
          <div class="md-form form-sm">
          <i class="fas fa-user prefix"></i>
          <input type="number" name="nik" id="form21" class="form-control form-control-sm {{$errors->has('nik')?'is-invalid':''}}">
